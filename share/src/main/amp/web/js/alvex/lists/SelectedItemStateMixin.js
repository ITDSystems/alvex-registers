define(["dojo/_base/declare",
   ...
   return declare([Core, _AlfDocumentListTopicMixin], {
      ...
      createSelectedItemSubscriptions: function alvex_lists_SelectedItemStateMixin__createSelectedItemSubscriptions() {
      ...
      deferredSelectionHandler: function alvex_lists_SelectedItemStateMixin__deferredSelectionHandler() {
         this.selectedItems = [];
      ...
      setDisabled: function alvex_lists_SelectedItemStateMixin__setDisabled(disable) {
         this.set("disabled", disable);
      },

      onItemDeselected: function alvex_lists_SelectedItemStateMixin__onItemDeselected(payload) {
      ...
      onItemSelected: function alvex_lists_SelectedItemStateMixin__onItemSelected(payload) {
         if (payload && payload.value)
         {
            var itemKey = lang.getObject(this.itemKeyProperty, false, payload.value);
            if (typeof itemKey !== "undefined")
      ...
      onItemSelectionCleared: function alvex_lists_SelectedItemStateMixin__onItemSelectionCleared(/*jshint unused:false*/ payload) {
      ...
      onSelectedItemsChange: function alvex_lists_SelectedItemStateMixin__onSelectedItemsChange(payload) {
      ...
      publishSelectedItems: function alvex_lists_SelectedItemStateMixin__publishSelectedItems() {
      ...
      retainPreviousItemSelectionState: function alvex_lists_SelectedItemStateMixin__retainPreviousItemSelectionState(items) {
